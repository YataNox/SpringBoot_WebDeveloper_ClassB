...
public class FormController {
	...
	public String test2(Model model, @RequestParam("id") String id, @RequestParam("name") String name){
		model.addAttribute("id", id);
		model.addAttribute("name", name);
		return "test2";
	}
	...
	@RequestMapping(value="/test4/{studentid}/{name}")
	public String test4(Model model, @PathVariable String studentid, @PathVariable String name){
